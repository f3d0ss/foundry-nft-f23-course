...
This is my example project for the 11th Lesson of the Cyfrin Solidity Course.

We gone through creating 2 different kinds of NFTs.
...
```
git clone https://github.com/f3d0ss/foundry-nft-f23-course
cd foundry-nft-f23-course
forge install
forge build
```
...
Mint an NFT using cast on locally deployed contract example: 

```
cast send <MOOD_NFT_CONTRACT_ADDRESS> "mintNft()" --private-key $SEPOLIA_PRIVATE_KEY --rpc-url $SEPOLIA_RPC_URL
```
